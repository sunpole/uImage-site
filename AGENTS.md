...
- Do not add a browser engine demo until its distribution model and disclosure boundary are explicitly approved. Static comparisons of approved reduced inputs and generated outputs are allowed; they must not process user files or expose engine code.
...
Репозиторий: `sunpole/uImage-site`.
